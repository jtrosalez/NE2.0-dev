$(document).ready(function(){	
	...
	$("#sub").click(function(){
		...
		var url17 = 'http://geocoding.geo.census.gov/geocoder/geographies/onelineaddress?address=' + add +'&benchmark=Public_AR_Current&vintage=ACS2017_Current&layers_Census2020&layers=tract&format=json'; //Create the url needed to geocode the address from Census
		var url22 = 'http://geocoding.geo.census.gov/geocoder/geographies/onelineaddress?address=' + add +'&benchmark=Public_AR_Current&vintage=ACS2022_Current&layers=tract&format=json';
